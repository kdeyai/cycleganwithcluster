...
# from models.clustering_loss import Clustering_loss
...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            # self.contextual = Clustering_loss()
    ...
    def backward_G(self):
        ...
        # if (self.iter >= 40 and self.iter % 20 == 0):
        #     self.loss_cx = self.contextual.cal_loss(self.fake_B)
        #     self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B + self.loss_cx
        # else:
